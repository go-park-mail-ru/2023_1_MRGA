...
type UserInfo struct {
	Id          uint   `sql:"unique;type:uuid;primary_key;default:" json:"userInfoId" gorm:"primaryKey;unique"`
...
type UserFilter struct {
	Id        uint `sql:"unique;type:uuid;primary_key;default:" json:"userFilterId" gorm:"primaryKey;unique"`
	UserId    uint `json:"userId" gorm:"foreignKey;unique"`
...
type UserReason struct {
	Id       uint `sql:"unique;type:uuid;primary_key;default:" json:"userReasonId" gorm:"primaryKey;unique"`
	UserId   uint `json:"userId" gorm:"foreignKey"`
...
type UserHashtag struct {
	Id        uint `sql:"unique;type:uuid;primary_key;default:" json:"userHashtag" gorm:"primaryKey;unique"`
	UserId    uint `json:"userId" gorm:"foreignKey"`
...
type UserReaction struct {
	Id         uint `sql:"unique;type:uuid;primary_key;default:" json:"userReactionId" gorm:"primaryKey;unique"`
	UserId     uint `json:"userId" gorm:"foreignKey"`
